...
<!-- table ------------------------------------------------------------------------->
        ...
        <div class="container tble"> 
          ...
          <div class="hedr"></div>
            ...
            <a href="<?= base_url('pasien/tambah');?>" class="btn" id="bth">
                  ...
                  <tbody>
                       <?php $no=1; foreach ($pasien as $p){ ?>
                          <tr>
                            ...
                            <td><?=  $p['umur'];?></td>
                            <td>
                                <a href="<?= base_url().'pasien/edit/'.$p['id_pasien'];?>" class="btn1 ">Edit</a>
                                <a href="<?= base_url().'pasien/hapus/'.$p['id_pasien'];?>" class="btn1" onCLick="return confirm('Yakin akan menghapus data')">Hapus</a>  
                            </td>
                          </tr>
                          <?php $no++; } ?>     
                  </tbody>
