...
<!-- navbar-------------------------------------------------------------------------->
     <nav class="navbar bar2 navbar-light ">
      <h4 class="navbar-brand ml-4">Edit Data Pasien</h4>
...
<!-- table ------------------------------------------------------------------------->
        ...
        <div class="container tble"> 
          ...
          <div class="hedr"></div>
            ...
            <a href="<?= base_url('pasien');?>" class="btn" id="bth">
            ...
            <div class="form_tmbh">
              ...
              <form method="POST" action="<?= base_url('pasien/update');?>">
                ...
                <div class="form-group">
                  <label for= "" id="ups">Nama Pasien</label>
                  <input type="text" name="nama_pasien" value="<?= $p['nama_pasien'];?>"  class="form-control">
                </div>
                ...
                <div class="form-group">
                  <label for= "" id="ups">Umur</label>
                  <input type="text" name="umur"  value="<?= $p['umur'];?>" class="form-control">
                </div>
