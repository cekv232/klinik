...
<!-- table ------------------------------------------------------------------------->
        ...
        <div class="container tble"> 
          ...
          <div class="hedr"></div>
            ...
            <a href="<?= base_url('kunjungan');?>" class="btn" id="bth">
            ...
            <div class="form_tmbh">
                 ...
                 <form method="POST" action="<?= base_url('kunjungan/update');?>">
                    ...
                    <div class="form-group">
                      <label for= "" id="ups">Tanggal Berobat</label>
                      <input type="date" name="tgl_berobat" value="<?= $edit['tgl_berobat'];?>" class="form-control" >
                    </div>

                     <div class="form-group">
                      <label for= "" id="ups">Pasien</label>
                    ...
                    <div class="form-group">
                      <label for= "" id="ups">Dokter Tujuan</label>
