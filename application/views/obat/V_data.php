...
<!-- navbar-------------------------------------------------------------------------->
     <nav class="navbar bar2 navbar-light ">
      <h4 class="navbar-brand ml-4">Halaman Obat</h4>
...
<!-- table ------------------------------------------------------------------------->
        ...
        <div class="container tble"> 
          ...
          <div class="hedr"></div>
            ...
            <a href="<?= base_url('obat/tambah');?>" class="btn" id="bth">
                  ...
                  <tbody>
                       <?php $no=1; foreach ($obat as $r){ ?>
                          <tr>
                            ...
                            <td><?=  $r['nama_obat'];?></td>
                            <td>
                                <a href="<?= base_url().'obat/edit/'.$r['id_obat'];?>" class="btn1 ">Edit</a>
                                <a href="<?= base_url().'obat/hapus/'.$r['id_obat'];?>" class="btn1" onCLick="return confirm('Yakin akan menghapus data')">Hapus</a>  
                            </td>
                          </tr>
                          <?php $no++; } ?>     
                  </tbody>
