...
<!-- navbar-------------------------------------------------------------------------->
     <nav class="navbar bar2 navbar-light ">
      <h4 class="navbar-brand ml-4">Tambah Data Dokter</h4>
...
<!-- table ------------------------------------------------------------------------->
        ...
        <div class="container tble"> 
          ...
          <div class="hedr"></div>
            ...
            <a href="<?= base_url('dokter');?>" class="btn" id="bth">
            ...
            <div class="form_tmbh">
              ...
              <form method="POST" action="<?= base_url('dokter/update');?>">
                ...
                <div class="form-group">
                  <label for= "" id="ups">Nama dokter</label>
                  <input type="text" name="nama_dokter"  value="<?= $d['nama_dokter'];?>" class="form-control">
                </div>
