...
<!-- navbar-------------------------------------------------------------------------->
     <nav class="navbar bar2 navbar-light ">
      <h4 class="navbar-brand ml-4">Halaman Dokter</h4>
...
<!-- table ------------------------------------------------------------------------->
        ...
        <div class="container tble"> 
          ...
          <div class="hedr"></div>
            ...
            <a href="<?= base_url('dokter/tambah');?>" class="btn" id="bth">
                  ...
                  <tbody>
                       <?php $no=1; foreach ($dokter as $d){ ?>
                          <tr>
                            ...
                            <td><?=  $d['nama_dokter'];?></td>
                            <td>
                                <a href="<?= base_url().'dokter/edit/'.$d['id_dokter'];?>" class="btn1 ">Edit</a>
                                <a href="<?= base_url().'dokter/hapus/'.$d['id_dokter'];?>" class="btn1" onCLick="return confirm('Yakin akan menghapus data')">Hapus</a>  
                            </td>
                          </tr>
                          <?php $no++; } ?>     
                  </tbody>
